...
## HW 5 - Необходимо попробовать клиент-серверное взаимодействие через синхронные сокеты.
...
## HW 6 - Необходимо попробовать клиент-серверное взаимодействие с использованием механизмов мультиплексирования.
...
## HW 7 - Необходимо получить опыт работы с IPC. Нужно создать приложение клиента и сервера.
...
man 7 unix
## HW 8 - Необходимо написать обработчик сигнала SIGSEGV.
...
## HW 9 - Необходимо описать работу загрузчика из MBR, а именно:
